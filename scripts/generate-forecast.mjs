...
const races = [
  ...
  { state: "TX", seat: "Open seat", incumbent: "John Cornyn", hold: "R", caucusTarget: "D", rating: "Tilt R", pvi: -5, pastSenate: -5, money: .6, candidate: .55, approval: -.28, primary: "resolved", primaryDate: "2026-05-26", nomination: .1, independent: "none", polls: [[-150, 38], [-92, 41], [-48, 44], [-13, 46]], note: "Paxton is treated as the Republican nominee after the May 26 runoff call; the open-seat general election now runs as Talarico versus Paxton." },
