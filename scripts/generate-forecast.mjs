...
const races = [
  ...
  { state: "TX", seat: "John Cornyn", incumbent: "John Cornyn", hold: "R", caucusTarget: "D", rating: "Tilt R", pvi: -5, pastSenate: -5, money: .6, candidate: .7, approval: -.25, primary: "runoff", primaryDate: "2026-05-26", nomination: .82, independent: "none", polls: [[-150, 38], [-92, 41], [-48, 44], [-13, 46]], note: "Paxton entered the runoff with polling strength and Trump's endorsement, but the model keeps the GOP nomination unresolved until the runoff is decided." },
...
const CANDIDATE_STATUS = {
  ...
  TX: { dem: "James Talarico", rep: "Ken Paxton / John Cornyn runoff", demStatus: "nominee", repStatus: "unresolved", primarySummary: "Talarico is nominated. Paxton has Trump's endorsement and polling strength, but Cornyn and Paxton still face a May 26 Republican runoff." },
