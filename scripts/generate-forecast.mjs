...
const SENATE_CANDIDATE_DEMOGRAPHIC_PROFILES = {
  ...
  "mike rogers": { profile: "Michigan establishment Republican", scores: { white_college: -.02, white_noncollege: .18, black: -.1, latino: -.04, asian_other: -.03, youth: -.06, senior: .12 }, strengths: ["White non-college", "65+"], weaknesses: ["Black", "18-29"] },
